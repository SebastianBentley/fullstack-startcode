...
describe("## Verify the Positions Facade ##", () => {
    ...
    describe("Verify the findNearbyFriends method", () => {
        it("Should Not find ", async () => {
            const result = await positionFacade.findNearbyFriends("pp@b.dk", 12.48, 55.77, DIST_TO_SEARCH, "secret")
    ...
    describe("Verify the findNearbyFriends method", () => {
        it("Should Not find xxxxxxxx@b.dk", async () => {
            await expect(positionFacade.findNearbyFriends("xxxxxxxx@b.dk", 12.48, 55.77, DIST_TO_SEARCH, "secret")).to.be.rejectedWith(ApiError)
        })
    })
